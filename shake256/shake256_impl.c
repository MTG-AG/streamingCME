...
static inline void _sponge_squeeze(keccak_sponge* const __restrict sponge,
...
static inline void _sponge_absorb(keccak_sponge* const __restrict sponge,
...
static inline void _shake_pad(keccak_sponge* const __restrict sponge) {
...
static inline void _sponge_forget(keccak_sponge* const __restrict sponge,
                                  const size_t len) {
  size_t remaining = len;
  while (remaining) {
    size_t cando = sponge_rate - sponge->position;
 ...
 *         been initialized.
 */
int shake256_absorb(keccak_sponge* const __restrict sponge,
...
int shake256(uint8_t* const __restrict out,
             const size_t outlen,
             const uint8_t* const __restrict in,
             const size_t inlen) {
  int err = 0;
...
int sprng256_init(keccak_sponge* const __restrict sponge,
...
int sprng256_squeeze(keccak_sponge* const __restrict sponge,
                     uint8_t* const __restrict out,
                     const size_t outlen) {
  if (sponge == NULL) {
    return SPONGERR_NULL;
...
int sprng256_random(keccak_sponge* const __restrict sponge,
                    uint8_t* const __restrict out,
                    const size_t outlen) {
