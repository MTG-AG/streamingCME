// Taken from https://github.com/coruus/keccak-tiny/tree/multicall-shake256 (CC0 license)

#ifndef SHAKE256_IMPL_H
#define SHAKE256_IMPL_H
 ...
 */
int shake256(uint8_t* const __restrict out, const size_t outlen,
             const uint8_t* const __restrict in, const size_t inlen);
